...
export default function About() {
  ...
  const stack = t.raw("stack") as Array<{ category: string; items: string[] }>;
  ...
  return (
    <section id="sobre-mi" aria-labelledby="sobre-mi-heading" className="relative py-24 md:py-36 px-6 overflow-hidden">
      <h2 id="sobre-mi-heading" className="sr-only">{t("heading")}</h2>
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div
          ...
          ref={heading.ref}
        >
          <span className="font-sans text-[10px] tracking-[0.25em] text-muted uppercase">{t("label")}</span>
          ...
          <div style={col(100).style} className={`${col(100).className} md:pl-14`}>
            ...
            <div className="grid grid-cols-2 gap-3">
              <div className="relative aspect-[3/4] rounded-sm overflow-hidden">
                <Image src="/images/sobre-mi-1.jpg" alt={t("imageAlt")} fill className="object-cover" sizes="(max-width: 768px) 50vw, 25vw" />
              </div>
              <div className="relative aspect-[3/4] rounded-sm overflow-hidden mt-8">
                <Image src="/images/sobre-mi-2.jpg" alt={t("imageAlt")} fill className="object-cover" sizes="(max-width: 768px) 50vw, 25vw" />
              </div>
              <div className="relative aspect-[3/4] rounded-sm overflow-hidden -mt-4">
                <Image src="/images/sobre-mi-3.jpeg" alt={t("imageAlt")} fill className="object-cover" sizes="(max-width: 768px) 50vw, 25vw" />
              </div>
              <div className="relative aspect-[3/4] rounded-sm overflow-hidden mt-4">
                <Image src="/images/sobre-mi-4.jpeg" alt={t("imageAlt")} fill className="object-cover" sizes="(max-width: 768px) 50vw, 25vw" />
              </div>
            </div>
          </div>
